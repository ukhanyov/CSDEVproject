...
public class Constants {
    ...
    public static final String DEFAULT_PHONE_NUMBER = "+380674928368";
    public static final String DEFAULT_FIREBASE_USER_ID = "3217219709";
    ...
    public static final String CLICK_KEY_VIEW_MESSAGE = "view_message";
    public static final String CLICK_KEY_BUTTON_CONNECT = "button_connect";
    ...
    public static final String PREF_PROFILE_FULL_NAME = "pref_profile_full_name";
